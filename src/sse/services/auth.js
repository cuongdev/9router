import { getProviderConnections, validateApiKey, updateProviderConnection, getSettings, getActiveApiKeyByKey, getProxyPools } from "@/lib/localDb";
...
export async function getProviderCredentials(provider, excludeConnectionIds = null, model = null, options = {}) {
  ...
  try {
    ...
    // after policy filtering so fallback never reaches unauthorized accounts.
